    ...
    <div class="container bottom_border">
        <div class="row">
            <div class=" col-sm-4 col-md col-sm-4  col-12 col">
                ...
                <p><i class="fa fa fa-envelope"></i><spring:message code="mobile.footer"/></p>
            </div>
            <div class=" col-sm-4 col-md  col-6 col"></div>

            <div class=" col-sm-4 col-md  col-6 col">
                <h5 class="headin5_amrc col_white_amrc pt2"><spring:message code="category.footer"/></h5>
                <!--headin5_amrc-->
                <ul class="footer_ul_amrc">
                    <c:forEach var="el" items="${categories}">
                        <li><a href="/main#${el.id}">${el.name}</a></li>
                    </c:forEach>
                </ul>
