...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="row">
        ...
        <p class="lead mb-0"><a href="/basket" class="text-white font-weight-bold"><spring:message code="basket.profile"/></a></p>
        <p class="lead mb-0"><a href="userPage/edit/<c:out value="${currentUser.id}"/>" class="text-white font-weight-bold"><spring:message code="edit.profile"/></a>
            <a href="/changeImg" class="text-white font-weight-bold"><spring:message code="photo.profile"/></a></p>
    </div>
    <!-- <div class="col-md-5">
        <img src="https://w-dog.ru/wallpapers/13/9/505795850978289/muzhchina-minimalizm-siluet-ten-chelovek-paren-malchik-bantik-galstuk-babaochka-krasnyj-seryj.jpg" width="15%" height="15%">
    </div>  -->
