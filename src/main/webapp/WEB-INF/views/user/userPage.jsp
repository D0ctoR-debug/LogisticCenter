...
<div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="row">
        ...
        <p class="lead mb-0"><a href="userPage/edit/<c:out value="${currentUser.id}"/>"
                                class="text-white font-weight-bold"><spring:message code="edit.profile"/></a></p>
        ...
        <p class="lead mb-0">
            ...
            <a href="/allUsers" class="text-white font-weight-bold"><spring:message code="all.allUsers"/></a>
