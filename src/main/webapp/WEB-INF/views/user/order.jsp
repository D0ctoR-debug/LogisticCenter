...
<div class="post-wrap">
    <div class="post-item">
        <div class="item-content">
            ...
            <div class="item-body">
                <h3 class="text-center"><spring:message code="confirmation.order"/></h3>
                ...
                <li><spring:message code="total.order"/> ${basketModel.basketInfos.size()} <spring:message code="sentence.order"/>
            ...
            <div class="item-footer">
                <c:if test="${basketModel.basketInfos.size()==0}">
                    <h3><spring:message code="move.order"/><a href="/basket" class="link"><spring:message code="basketMove.order"/> </a><spring:message code="sentenceTwo.order"/> </h3>
