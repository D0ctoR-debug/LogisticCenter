...
<div class="dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
        <li><a class="dropdown-item" href="/allOrders/ASC"><spring:message code="asc.order"/></a></li>
        <li><a class="dropdown-item" href="/allOrders/desc"><spring:message code="desc.order"/></a></li>
    </ul>
</div>
