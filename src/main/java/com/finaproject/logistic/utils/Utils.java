...
public class Utils {
    ...
    public static void storeLastOrderedBasketInSession(HttpServletRequest request, com.finaproject.logistic.entity.Basket basket) {
        request.getSession().setAttribute("lastOrderedBasket", basket);
    }

    public static com.finaproject.logistic.entity.Basket getLastOrderedBasketInSession(HttpServletRequest request) {
        return (com.finaproject.logistic.entity.Basket) request.getSession().getAttribute("lastOrderedBasket");
    }
}
